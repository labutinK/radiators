...
/* harmony import */ var inputmask_lib_inputmask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! inputmask/lib/inputmask.js */ "./node_modules/inputmask/lib/inputmask.js");
...
/* harmony import */ var simplebar_dist_simplebar_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! simplebar/dist/simplebar.css */ "./node_modules/simplebar/dist/simplebar.css");
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.blog-detail__slider .swiper', {
    spaceBetween: 0,
    slidesPerView: 1,
    preloadImages: false,
    lazy: true,
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.other-news__slider .swiper', {
    spaceBetween: 16,
    slidesPerView: "auto",
    preloadImages: false,
    lazy: true,
  ...
  document.querySelectorAll('.catalog-card__photo').forEach(function (photoBlock, index) {
    ...
    if (swiperContainer && pagination) {
      var slider = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"](swiperContainer, {
        spaceBetween: 0,
        slidesPerView: 1,
        pagination: {
          el: pagination,
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.welcome__slider .swiper', {
    slidesPerView: "auto",
    spaceBetween: 20,
    breakpoints: {
      768: {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.categories-slider__content .swiper', {
    slidesPerView: "auto",
    spaceBetween: 20,
    breakpoints: {
      769: {
    ...
    navigation: {
      nextEl: '.categories-slider__content .slider-next',
      prevEl: '.categories-slider__content .slider-prev'
    }
  });
  // new Swiper('.galery-slider__wrapper .swiper', {
  //     slidesPerView: .4,
  //     spaceBetween: 6,
  //     freeMode: true,
  //     loop: true,
  ...
  new ImageGallery('.sertificats__slider img');
  ...
  var sideSlider = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.good-detail__side-slider .swiper', {
    slidesPerView: "auto",
  ...
  var mainSlider = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.good-detail__main-slider .swiper', {
    slidesPerView: 1,
    // Один слайд за раз
    spaceBetween: 0,
    // Без отступов
  ...
  document.querySelectorAll('.products-list').forEach(function (productsList, index) {
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_3__["default"](swiperContainer, {
      spaceBetween: 0,
      preloadImages: false,
      lazy: true,
      slidesPerView: "auto",
  ...
  new Modal('leave-review').setAdditionalLogicAfterSubmit(function (wrapper) {
    ...
    if (form) {
      ...
      if (dz) {
        dropzone__WEBPACK_IMPORTED_MODULE_5__["default"].autoDiscover = false;
        var myDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_5__["default"](dz, {
          url: "/upload",
  ...
  var top = document.querySelector('.filter-body__top');
  var list = document.querySelector('.filter-body__list');
  var btns = document.querySelector('.filter-body__buttons');
  function updateListHeight() {
    if (top && list && btns) {
      var topHeight = top.offsetHeight;
      var btnsHeight = btns.offsetHeight;
      var availableHeight = topHeight + btnsHeight;
      list.style.maxHeight = "calc(100% - ".concat(availableHeight, "px)");
    }
  }
  function scrollTags() {
    var tagGap = document.querySelectorAll('.additional-tag');
    var container = document.querySelector('.container');
    if (tagGap.length > 0 && container) {
      var screenWidth = window.innerWidth; // Ширина окна
      var containerStyles = window.getComputedStyle(container);
      var containerPadding = parseFloat(containerStyles.paddingLeft) + parseFloat(containerStyles.paddingRight);
      var containerWidth = container.getBoundingClientRect().width - containerPadding; // Учитываем padding

      var scrollOffset = screenWidth / 2 - containerWidth / 2 - 10;
      tagGap.forEach(function (tagGapEl) {
        tagGapEl.style.minWidth = "".concat(scrollOffset, "px");
      });
    }
  }
  window.addEventListener('load', scrollTags);
  window.addEventListener('resize', scrollTags);
  window.addEventListener('load', updateListHeight);
  window.addEventListener('resize', updateListHeight);
  if (document.querySelector('.catalog__sub')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_7__["default"](document.querySelector('.catalog__sub'), {
      autoHide: false,
      forceVisible: true
    });
  }
  if (document.querySelector('.filter-body__list')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_7__["default"](document.querySelector('.filter-body__list'), {
      autoHide: false
    });
  }
  if (document.querySelector('.features__content')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_7__["default"](document.querySelector('.features__content'), {
      autoHide: false
    });
  }
  if (document.querySelector('.good-tabs__top')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_7__["default"](document.querySelector('.good-tabs__top'), {
      autoHide: false
    });
  }
  if (document.querySelector('.tabs')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_7__["default"](document.querySelector('.tabs'), {
      autoHide: false
    });
  }
  if (document.querySelector('.info-tabs__top')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_7__["default"](document.querySelector('.info-tabs__top'), {
      autoHide: false
    });
  }
  if (document.querySelectorAll('.galery-slider__slide').length > 0) {
    var boxes = gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.utils.toArray(".galery-slider__slide");
    var loop = horizontalLoop(boxes, {
      paused: true,
      // Sets the tween to be paused initially
      repeat: -1,
      // Makes sure the tween runs infinitely
      speed: .8
    });
  ...
  function horizontalLoop(items, config) {
    items = gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.utils.toArray(items);
    config = config || {};
    var tl = gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.timeline({
      ...
      snap = config.snap === false ? function (v) {
        return v;
      } : gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.utils.snap(config.snap || 1),
      ...
      item,
      i;
    gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.set(items, {
      // convert "x" to "xPercent" to make things responsive, and populate the widths/xPercents Arrays to make lookups faster.
      xPercent: function xPercent(i, el) {
        var w = widths[i] = parseFloat(gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.getProperty(el, "width", "px"));
        xPercents[i] = snap(parseFloat(gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.getProperty(el, "x", "px")) / w * 100 + gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.getProperty(el, "xPercent"));
        return xPercents[i];
      }
    });
    gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.set(items, {
    ...
    totalWidth = items[length - 1].offsetLeft + xPercents[length - 1] / 100 * widths[length - 1] - startX + items[length - 1].offsetWidth * gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.getProperty(items[length - 1], "scaleX") + (parseFloat(config.paddingRight) || 0);
    for (i = 0; i < length; i++) {
      item = items[i];
      curX = xPercents[i] / 100 * widths[i];
      distanceToStart = item.offsetLeft + curX - startX;
      distanceToLoop = distanceToStart + widths[i] * gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.getProperty(item, "scaleX");
      tl.to(item, {
    ...
    function toIndex(index, vars) {
      ...
      var newIndex = gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.utils.wrap(0, length, index),
        time = times[newIndex];
      if (time > tl.time() !== index > curIndex) {
        // if we're wrapping the timeline's playhead, make the proper adjustments
        vars.modifiers = {
          time: gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.utils.wrap(0, tl.duration())
        };
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initLoader: function() { return /* binding */ initLoader; }
/* harmony export */ });
var initLoader = function initLoader() {
  var loader = document.querySelector('.loader');
  var startTime = performance.now(); // Засекаем время старта
  if (loader) {
    var bodyEl = document.querySelector('body');
    bodyEl.classList.add('lock');
    document.addEventListener('DOMContentLoaded', function () {
      var elapsedTime = performance.now() - startTime; // Считаем, сколько уже прошло

      var remainingTime = Math.max(1500 - elapsedTime, 0); // Сколько еще подождать
...
/******/ })()
;
//# sourceMappingURL=main.561ae59ce47961872ed7.js.map