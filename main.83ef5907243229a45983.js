...
/* harmony import */ var simplebar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! simplebar */ "./node_modules/simplebar/dist/index.mjs");
/* harmony import */ var simplebar_dist_simplebar_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! simplebar/dist/simplebar.css */ "./node_modules/simplebar/dist/simplebar.css");
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  if (document.querySelector('.catalog__sub')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_6__["default"](document.querySelector('.catalog__sub'), {
      autoHide: false,
      forceVisible: true
    });
  }
  if (document.querySelector('.filter-body__list')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_6__["default"](document.querySelector('.filter-body__list'), {
      autoHide: false
    });
  }
  if (document.querySelector('.features__content')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_6__["default"](document.querySelector('.features__content'), {
      autoHide: false
    });
  }
  if (document.querySelector('.tabs')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_6__["default"](document.querySelector('.tabs'), {
      autoHide: false
    });
  }
  if (document.querySelector('.info-tabs__top')) {
    new simplebar__WEBPACK_IMPORTED_MODULE_6__["default"](document.querySelector('.info-tabs__top'), {
      autoHide: false
    });
  }
  if (document.querySelectorAll('.galery-slider__slide').length > 0) {
    var boxes = gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.utils.toArray(".galery-slider__slide");
  ...
  function horizontalLoop(items, config) {
    items = gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.utils.toArray(items);
    config = config || {};
    var tl = gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.timeline({
      ...
      snap = config.snap === false ? function (v) {
        return v;
      } : gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.utils.snap(config.snap || 1),
      ...
      item,
      i;
    gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.set(items, {
      // convert "x" to "xPercent" to make things responsive, and populate the widths/xPercents Arrays to make lookups faster.
      xPercent: function xPercent(i, el) {
        var w = widths[i] = parseFloat(gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.getProperty(el, "width", "px"));
        xPercents[i] = snap(parseFloat(gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.getProperty(el, "x", "px")) / w * 100 + gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.getProperty(el, "xPercent"));
        return xPercents[i];
      }
    });
    gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.set(items, {
    ...
    totalWidth = items[length - 1].offsetLeft + xPercents[length - 1] / 100 * widths[length - 1] - startX + items[length - 1].offsetWidth * gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.getProperty(items[length - 1], "scaleX") + (parseFloat(config.paddingRight) || 0);
    for (i = 0; i < length; i++) {
      item = items[i];
      curX = xPercents[i] / 100 * widths[i];
      distanceToStart = item.offsetLeft + curX - startX;
      distanceToLoop = distanceToStart + widths[i] * gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.getProperty(item, "scaleX");
      tl.to(item, {
    ...
    function toIndex(index, vars) {
      ...
      var newIndex = gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.utils.wrap(0, length, index),
        time = times[newIndex];
      if (time > tl.time() !== index > curIndex) {
        // if we're wrapping the timeline's playhead, make the proper adjustments
        vars.modifiers = {
          time: gsap__WEBPACK_IMPORTED_MODULE_8__.gsap.utils.wrap(0, tl.duration())
        };
...
/******/ })()
;
//# sourceMappingURL=main.83ef5907243229a45983.js.map