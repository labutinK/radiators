...
var Modal = /*#__PURE__*/function () {
  function Modal(id) {
    ...
    _defineProperty(this, "_overlayOn", function (_ref) {
      ...
      if (!target.classList.contains('modal') && !target.closest('.modal') && !target.classList.contains('dz-hidden-input')) {
        _this._closeModal();
      }
    });
    ...
    this._id = id;
    this._btns = document.querySelectorAll("[data-btn-modal='".concat(id, "']"));
